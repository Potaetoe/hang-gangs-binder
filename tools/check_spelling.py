...
PINNED = {
    ...
    ("apps/web/dashboard.js", "metric units (-tre)"): 1,
    ("apps/web/dashboard.js", "-ise family"): 1,
    ("apps/web/dashboard.js", "-ll- doubling"): 2,
    ("apps/web/theme.css", "-our words"): 1,
    ("dev/admin-session.test.mjs", "-ll- doubling"): 1,
    ("dev/admin.test.mjs", "-ise family"): 1,
    ("dev/dashboard.test.mjs", "metric units (-tre)"): 1,
    ("dev/dashboard.test.mjs", "-ise family"): 2,
    ("dev/dashboard.test.mjs", "-ll- doubling"): 1,
    ("dev/demo-config.js", "-ll- doubling"): 1,
    ("dev/demo-corpus.js", "-ll- doubling"): 1,
