...
LEDGER = [
    ...
    },
    {
        ...
        "claim": "the count of stale candidates the route sends beside "
                 ...
                 "the page says 'Showing 43 (checked 50 of 120)' in the "
                 "owner's refined words of 2026-08-22) comes out of the "
                 "SAME statement that builds the list, as "
                 "`COUNT(*) OVER ()`. "
                 ...
                 "total. WATCH FOR SILENCE, NOT FOR A WRONG NUMBER: the "
                 "page draws the line only when the total is past the "
                 "cap, so total == cap means it never appears at all, "
                 "and the defect looks exactly like a group that has no "
                 "more candidates than the cap - which is the very "
                 "blindness #458 F2 named, back and invisible. Point a "
